...
class Usuarios(object):
    ...
    def deleteUser(self):
        ...
        try:
            ...
            c.execute("delete from ususarios where idusuario = " + self.idusuario +"")
    ...
    def selectedUser(self, idusuario):
        banco = Banco()
        try:

            c = banco.conexao.cursor()

            c.execute("selected * from usuarios where idusuario = " + self.idusuario + "")
