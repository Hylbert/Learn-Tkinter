...
class Application:
    ...
    def __init__(self, master = None):
        ...
        self.bntInsert = Button(self.container8, text = 'Inserir', font=self.fontePadrao, width=12)
        self.bntInsert['command'] = self.inserirUsuario
        self.bntInsert.pack(side=LEFT)

        self.bntAlterar = Button(self.container8, text = 'Alterar', font=self.fontePadrao, width=12)
        self.bntAlterar['command'] = self.alterarUsuario
        self.bntAlterar.pack(side=LEFT)

        self.bntExcluir = Button(self.container8, text = 'Excluir', font=self.fontePadrao, width=12)
        self.bntExcluir['command'] = self.excluirUsuario
        self.bntExcluir.pack(side=LEFT)

        self.lblmsg = Label(self.container9, text = '')
        self.lblmsg['font']  = ('Consolas', '9', 'italic')
        self.lblmsg.pack()
    ...
    def inserirUsuario(self):
            ...
            user.usuario = self.txtemail.get()
